  ...
  methods: {
    _createSceneView: function () {
      ...
      loadModules(["esri/Map",
        ...
        "esri/renderers/support/ClassBreakInfo",], option).then(([Map, MapView, SceneView, TileLayer, WebScene, esriConfig, SceneLayer,
                                                                         FeatureLayer, Circle, Graphic, Home, Legend, Basemap, externalRenderers, SpatialReference, SimpleRenderer, SimpleLineSymbol,GraphicsLayer,Field
                                                                         ,ClassBreaksRenderer,ClassBreakInfo]) => {
